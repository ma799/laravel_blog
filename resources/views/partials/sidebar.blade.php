<div class="col-md-4 col-xl-3">
    <div class="sidebar px-4 py-md-0">
      ...
      <form id="searchForm" class="input-group" action="" method="GET">
        <input type="text" class="form-control" name="search" placeholder="Search">
        <div onclick="sub()" class="input-group-addon" style="cursor: pointer;">
      ...
      <div class="row link-color-default fs-14 lh-24">
        ...
        <div class="col-6"><a href="{{ route('blogPosts.category',$category->id) }}">{{ $category->name }}</a></div>
      @endforeach
      </div>
      ...
      <a class="media text-default align-items-center mb-5" href="blog-single.html">
        <img class="rounded w-65px mr-4" src="{{ asset('assets/img/thumb/4.jpg') }}">
        <p class="media-body small-2 lh-4 mb-0">Thank to Maryam for joining our team</p>
      </a>

      <a class="media text-default align-items-center mb-5" href="blog-single.html">
        <img class="rounded w-65px mr-4" src="{{ asset('assets/img/thumb/3.jpg') }}">
        <p class="media-body small-2 lh-4 mb-0">Best practices for minimalist design</p>
      </a>

      <a class="media text-default align-items-center mb-5" href="blog-single.html">
        <img class="rounded w-65px mr-4" src="{{ asset('assets/img/thumb/5.jpg') }}">
        <p class="media-body small-2 lh-4 mb-0">New published books for product designers</p>
      </a>

      <a class="media text-default align-items-center mb-5" href="blog-single.html">
        <img class="rounded w-65px mr-4" src="{{ asset('assets/img/thumb/2.jpg') }}">
      ...
      <div class="gap-multiline-items-1">
        @foreach ($tags as $tag)
        <a class="badge badge-secondary" href="{{ route('blogPosts.tag',$tag->id) }}">{{ $tag->name }}</a>
      @endforeach
      </div>
